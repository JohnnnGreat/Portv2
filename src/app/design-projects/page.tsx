...
import { designProjectsMain } from "@/designcnst";
    ...
    <>
      ...
      <div className="max-w-[1000px] mx-auto p-[1rem]">
        ...
        <h1 className="text-[3rem]  md:text-5xl lg:text-[4.5rem] font-bold leading-[1] font-Mark max-w-full sm:max-w-[100%] md:max-w-[70%] lg:max-w-[80%] mt-[2rem]">
          Check out some of the cool stuff I've designed
        </h1>
        ...
        <div className="flex flex-wrap gap-[3rem] mt-[3rem]">
          {designProjectsMain.map((project, idx) => (
            <div
              key={idx}
              className="w-full md:w-[calc(50%-1.5rem)] rounded-[40px] border p-[20px] md:p-[40px] bg-[#fafafa98] relative"
            >
